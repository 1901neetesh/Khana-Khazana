        ...
        >
          <Card className="bg-white/10 backdrop-blur-xl border-white/20 mb-12">
            <CardHeader>
              ...
              >
                <div className="w-12 h-12 bg-white/20 backdrop-blur-md border-white/30 rounded-xl flex items-center justify-center">
            ...
            <CardContent className="space-y-6">
                ...
                {ingredients.map((ingredient, index) => (
                  ...
                  >
                    <Input
                      ...
                      className="flex-1 bg-white/20 backdrop-blur-md border-white/30 text-white placeholder-white/60 focus:bg-white/30 focus:border-white/50"
                    />
              ...
              <div className="flex gap-4">
                ...
                >
                  <Button
                    ...
                    variant="secondary"
                    className="px-6 py-4 bg-white/20 backdrop-blur-md border-white/30 text-white hover:bg-white/30"
                  >
                ...
                >
                  <Button
                    ...
                    disabled={loading}
                    className="w-full px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold hover:from-orange-600 hover:to-red-700 disabled:opacity-50"
                  >
                    {loading ? (
              ...
              {error && (
                <motion.div
                  className="p-4 bg-red-500/20 backdrop-blur-md border-red-400/30 text-white rounded-xl"
          ...
          >
            <Card className="bg-white/10 backdrop-blur-xl border-white/20">
              <CardHeader>
                ...
                >
                  <div className="w-14 h-14 bg-white/20 backdrop-blur-md border-white/30 rounded-xl flex items-center justify-center">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <Button
                        ...
                        variant="secondary"
                        size="icon"
                        className="bg-white/20 backdrop-blur-md border-white/30 text-white hover:bg-white/30 print:hidden"
                        title="Print Recipe"
                      >
              ...
              <CardContent className="space-y-8">
                <motion.div
                  className="flex flex-col sm:flex-row gap-4 bg-white/10 backdrop-blur-md border-white/20 rounded-2xl p-6"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.6, duration: 0.6 }}
                >
                    ...
                    <CardContent className="p-6">
                      ...
                      >
                        {(isHindi ? recipe.instructionsHindi : recipe.instructions).map((instruction, index) => (
                          ...
                          >
                            <div className="flex-shrink-0 w-8 h-8 bg-white/20 backdrop-blur-md border-white/30 rounded-full flex items-center justify-center text-sm font-bold text-white">
                              {index + 1}
                            </div>
        ...
        >
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10">
            <CardContent className="p-8 md:p-12">
              ...
              >
                <Badge variant="secondary" className="bg-white/10 backdrop-blur-md border-white/20 px-6 py-3">
                  ...
                  <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/15 transition-all duration-500">
                    <CardContent className="p-6">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-white/20 backdrop-blur-sm border-white/30 rounded-xl flex items-center justify-center group-hover:bg-white/30 transition-colors">
